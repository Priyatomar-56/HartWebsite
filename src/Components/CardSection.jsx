  ...
  return (
    <Container>
     ...
     <Container2>
        ...
        <Para class="card-text" marginleft={"85px"} width={"177px"} Resmarginleft={"59px"}>With a single click, store all of your medical documents in an organised manner.</Para>
        </Card>
        <Card>
        <Image src={Couple} class="card-img-top" marginleft={"105px"} width={260} height={313} Resmarginleft={"94px"} alt="Fissure in Sandstone"/>
        <Heading2 class="card-title" marginleft={"67px"} Resmarginleft={"37px"}>Take Care of Your<br/>Family.</Heading2>
        <Para class="card-text" marginleft={"45px"} width={"257px"}  Resmarginleft={"17px"}>Track the health of your parents and children.<br></br>Share your documents with doctors and revoke access anytime.</Para>
        </Card>
        <Card>
        <Image src={Face} class="card-img-top" marginleft={"45px"} width={260} height={313} Resmarginleft={"44px"}alt="Fissure in Sandstone"/>
        <Heading2 class="card-title" marginleft={"57px"} Resmarginleft={"8px"}>Insights on Your Health.</Heading2>
        <Para class="card-text" marginleft={"55px"} width={"257px"} Resmarginleft={"16px"}>Get infographics and other interpretations of your medical history to better understand your health!</Para>
        </Card>
        </Container2>
        <Container3>
        <Containerleft>
